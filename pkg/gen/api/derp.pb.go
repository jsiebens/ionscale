...
func (x *GetDERPMapRequest) Reset() {
	*x = GetDERPMapRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_derp_proto_msgTypes[0]
...
func (*GetDERPMapRequest) Descriptor() ([]byte, []int) {
	return file_api_derp_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetDERPMapResponse) Reset() {
	*x = GetDERPMapResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_derp_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetDERPMapResponse) Descriptor() ([]byte, []int) {
	return file_api_derp_proto_rawDescGZIP(), []int{1}
}
...
func (x *SetDERPMapRequest) Reset() {
	*x = SetDERPMapRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_derp_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetDERPMapRequest) Descriptor() ([]byte, []int) {
	return file_api_derp_proto_rawDescGZIP(), []int{2}
}
...
func (x *SetDERPMapResponse) Reset() {
	*x = SetDERPMapResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_derp_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetDERPMapResponse) Descriptor() ([]byte, []int) {
	return file_api_derp_proto_rawDescGZIP(), []int{3}
}
...
var file_api_derp_proto_rawDesc = []byte{
	0x0a, 0x0e, 0x61, 0x70, 0x69, 0x2f, 0x64, 0x65, 0x72, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x13, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x44, 0x45, 0x52, 0x50,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x2a, 0x5a,
...
var (
	file_api_derp_proto_rawDescOnce sync.Once
	file_api_derp_proto_rawDescData = file_api_derp_proto_rawDesc
)

func file_api_derp_proto_rawDescGZIP() []byte {
	file_api_derp_proto_rawDescOnce.Do(func() {
		file_api_derp_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_derp_proto_rawDescData)
	})
	return file_api_derp_proto_rawDescData
}

var file_api_derp_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_derp_proto_goTypes = []interface{}{
	(*GetDERPMapRequest)(nil),  // 0: api.GetDERPMapRequest
	(*GetDERPMapResponse)(nil), // 1: api.GetDERPMapResponse
	(*SetDERPMapRequest)(nil),  // 2: api.SetDERPMapRequest
	(*SetDERPMapResponse)(nil), // 3: api.SetDERPMapResponse
}
var file_api_derp_proto_depIdxs = []int32{
...
func init() { file_api_derp_proto_init() }
func file_api_derp_proto_init() {
	if File_api_derp_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_derp_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_derp_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_derp_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_derp_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_derp_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_derp_proto_goTypes,
		DependencyIndexes: file_api_derp_proto_depIdxs,
		MessageInfos:      file_api_derp_proto_msgTypes,
	}.Build()
	File_api_derp_proto = out.File
	file_api_derp_proto_rawDesc = nil
	file_api_derp_proto_goTypes = nil
	file_api_derp_proto_depIdxs = nil
}
