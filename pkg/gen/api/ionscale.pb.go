...
var file_api_ionscale_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x72, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xd6, 0x0a, 0x0a, 0x08, 0x49,
	...
	,
...
var file_api_ionscale_proto_goTypes = []interface{}{
	...
	(*DeleteMachineRequest)(nil),     // 16: api.DeleteMachineRequest
	(*GetMachineRoutesRequest)(nil),  // 17: api.GetMachineRoutesRequest
	(*SetMachineRoutesRequest)(nil),  // 18: api.SetMachineRoutesRequest
	(*GetVersionResponse)(nil),       // 19: api.GetVersionResponse
	(*GetDERPMapResponse)(nil),       // 20: api.GetDERPMapResponse
	(*SetDERPMapResponse)(nil),       // 21: api.SetDERPMapResponse
	(*CreateTailnetResponse)(nil),    // 22: api.CreateTailnetResponse
	(*GetTailnetResponse)(nil),       // 23: api.GetTailnetResponse
	(*ListTailnetResponse)(nil),      // 24: api.ListTailnetResponse
	(*DeleteTailnetResponse)(nil),    // 25: api.DeleteTailnetResponse
	(*GetDNSConfigResponse)(nil),     // 26: api.GetDNSConfigResponse
	(*SetDNSConfigResponse)(nil),     // 27: api.SetDNSConfigResponse
	(*GetACLPolicyResponse)(nil),     // 28: api.GetACLPolicyResponse
	(*SetACLPolicyResponse)(nil),     // 29: api.SetACLPolicyResponse
	(*GetAuthKeyResponse)(nil),       // 30: api.GetAuthKeyResponse
	(*CreateAuthKeyResponse)(nil),    // 31: api.CreateAuthKeyResponse
	(*DeleteAuthKeyResponse)(nil),    // 32: api.DeleteAuthKeyResponse
	(*ListAuthKeysResponse)(nil),     // 33: api.ListAuthKeysResponse
	(*ListMachinesResponse)(nil),     // 34: api.ListMachinesResponse
	(*DeleteMachineResponse)(nil),    // 35: api.DeleteMachineResponse
	(*GetMachineRoutesResponse)(nil), // 36: api.GetMachineRoutesResponse
}
var file_api_ionscale_proto_depIdxs = []int32{
	...
	16, // 16: api.Ionscale.DeleteMachine:input_type -> api.DeleteMachineRequest
	17, // 17: api.Ionscale.GetMachineRoutes:input_type -> api.GetMachineRoutesRequest
	18, // 18: api.Ionscale.SetMachineRoutes:input_type -> api.SetMachineRoutesRequest
	19, // 19: api.Ionscale.GetVersion:output_type -> api.GetVersionResponse
	20, // 20: api.Ionscale.GetDERPMap:output_type -> api.GetDERPMapResponse
	21, // 21: api.Ionscale.SetDERPMap:output_type -> api.SetDERPMapResponse
	22, // 22: api.Ionscale.CreateTailnet:output_type -> api.CreateTailnetResponse
	23, // 23: api.Ionscale.GetTailnet:output_type -> api.GetTailnetResponse
	24, // 24: api.Ionscale.ListTailnets:output_type -> api.ListTailnetResponse
	25, // 25: api.Ionscale.DeleteTailnet:output_type -> api.DeleteTailnetResponse
	26, // 26: api.Ionscale.GetDNSConfig:output_type -> api.GetDNSConfigResponse
	27, // 27: api.Ionscale.SetDNSConfig:output_type -> api.SetDNSConfigResponse
	28, // 28: api.Ionscale.GetACLPolicy:output_type -> api.GetACLPolicyResponse
	29, // 29: api.Ionscale.SetACLPolicy:output_type -> api.SetACLPolicyResponse
	30, // 30: api.Ionscale.GetAuthKey:output_type -> api.GetAuthKeyResponse
	31, // 31: api.Ionscale.CreateAuthKey:output_type -> api.CreateAuthKeyResponse
	32, // 32: api.Ionscale.DeleteAuthKey:output_type -> api.DeleteAuthKeyResponse
	33, // 33: api.Ionscale.ListAuthKeys:output_type -> api.ListAuthKeysResponse
	34, // 34: api.Ionscale.ListMachines:output_type -> api.ListMachinesResponse
	35, // 35: api.Ionscale.DeleteMachine:output_type -> api.DeleteMachineResponse
	36, // 36: api.Ionscale.GetMachineRoutes:output_type -> api.GetMachineRoutesResponse
	36, // 37: api.Ionscale.SetMachineRoutes:output_type -> api.GetMachineRoutesResponse
